...
def read_file(file_name):
    ...
    sample_directory = '../gtts_transcribe/'
...
def reduce_noise_power(y, sr):
    ...
    threshold_l = 100 #round(np.median(cent))*0.1
...
def output_file(filename, y, sr):
    destination = '/home/tanzeel/Music/gtts_transcribe/audio/'
...
for file in os.listdir('audio/'):
	...
	output_file(file, y_reduced_centroid_mb, sr)
	#output_file(file, y_reduced_mfcc_up, sr)
